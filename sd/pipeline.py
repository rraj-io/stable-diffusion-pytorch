...
def generate(prompt: str,
    ...
    with torch.inference_mode():
        ...
        if input_image:
            ...
            # if we are doing text-to-image, satrt ith random noise N(0, 1)
        ...
        timsteps = tqdm(sampler.timesteps)
        for i, timestep in enumerate(timsteps):
            ...
            # model_output is teh predicted noise by the UNET
